            ...
            {onCreateTakeaway && (
                <button
                    ...
                    className={`relative rounded-xl border p-4 text-left transition-all overflow-hidden ${isTakeawayActive
                            ? 'ring-2 ring-[#D4553A] border-[#D4553A] bg-[#FFF5F3]'
                            : 'border-dashed border-[#E0DCD4] hover:border-[#D4553A] bg-white'
                        }`}
                >
                    <div className="flex justify-between items-start mb-3">
                        <span className="font-bold text-[#1A1A1A] text-lg">Mang về</span>
                        <div className="px-2 py-1 rounded-md text-[10px] font-bold bg-[#D4553A]/10 text-[#D4553A]">
                            Takeaway
                        </div>
                    </div>
                    <div className="text-xs text-[#6B6B6B] italic pt-5">
                ...
                return (
                    <button
                        ...
                        className={`relative rounded-xl border p-4 text-left transition-all overflow-hidden ${isSelected
                                ? 'ring-2 ring-[#D4553A] border-[#D4553A]'
                                : isOccupied
                                    ? 'border-[#F59E0B]/50 hover:border-[#F59E0B]'
                                    : 'border-[#E0DCD4] hover:border-[#10B981]/50'
                            } ${isOccupied
                                ? 'bg-[#FFFBEB]'
                                : 'bg-white'
                            }`}
                    >
                        ...
                        {/* Selection Indicator */}
                        {isSelected && (
                            <div className="absolute top-0 right-0 w-0 h-0 border-t-[24px] border-r-[24px] border-t-transparent border-r-[#D4553A]">
