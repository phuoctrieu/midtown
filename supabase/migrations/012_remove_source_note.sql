...
BEGIN
    ...
    IF p_action = 'accepted' THEN
        ...
        -- Removing the [Khách order] logic. It now just passes v_request.note as-is if provided by the customer.
        ...
        DO UPDATE SET 
            ...
            note = CASE 
                WHEN public.order_items.note IS NULL OR public.order_items.note = '' THEN EXCLUDED.note 
                WHEN EXCLUDED.note IS NOT NULL AND EXCLUDED.note <> '' THEN public.order_items.note || ' ' || EXCLUDED.note 
